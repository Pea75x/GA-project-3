...
const stations = [
  ...
  createStation('Aldgate', ['Metropolitan', 'CircleLine']),
  createStation('Aldgate East', ['Hammersmith&City', 'District']),
  createStation('Alperton', ['Piccadilly']),
  createStation('Amersham', ['Metropolitan']),
  createStation('Angel', ['Northern']),
  createStation('Archway', ['Northern']),
  createStation('Arnos Grove', ['Piccadilly']),
  createStation('Arsenal', ['Piccadilly']),
  createStation('Baker Street', [
    'Metropolitan',
    'Bakerloo',
    'CircleLine',
    'Jubilee',
  ...
  createStation('Balham', ['Northern']),
  createStation('Bank', ['Waterloo&City', 'Northern', 'Central']),
  createStation('Barbican', ['Metropolitan', 'Circle', 'Hammersmith&City']),
  createStation('Barking', ['District', 'Hammersmith&City']),
  createStation('Barons Court', ['District', 'Piccadilly']),
  createStation('Bayswater', ['District', 'CircleLine']),
  createStation('Belsize Park', ['Northern']),
  createStation('Bermondsey', ['Jubilee']),
  createStation('Bethnal Green', ['Central']),
  createStation('Blackfriars', ['District', 'Circle']),
  createStation('Blackhorse Road', ['Victoria']),
  createStation('Bond Street', ['Central', 'Jubilee']),
  createStation('Borough', ['Northern']),
  createStation('Boston Manor', ['Piccadilly']),
  createStation('Bow Road', ['District', 'Hammersmith&City']),
  createStation('Brent Cross', ['Northern']),
  createStation('Brixton', ['Victoria']),
  createStation('Bromley-by-Bow', ['District', 'Hammersmith&City']),
  createStation('Buckhurst Hill', ['Central']),
  createStation('Burnt Oak', ['Northern']),
  createStation('Caledonian Road', ['Piccadilly']),
  createStation('Camden Town', ['Northern']),
  createStation('Canada Water', ['Jubilee']),
  createStation('Canary Wharf', ['Jubilee']),
  createStation('Canning Town', ['Jubilee']),
  createStation('Cannon Street', ['District', 'CircleLine']),
  createStation('Canons Park', ['Jubilee']),
  createStation('Chalfont & Latimer', ['Metropolitan']),
  createStation('Chalk Farm', ['Northern']),
  createStation('Chancery Lane', ['Central']),
  createStation('Charing Cross', ['Bakerloo', 'Northern']),
  createStation('Chesham', ['Metropolitan']),
  createStation('Chigwell', ['Central']),
  createStation('Chiswick Park', ['District']),
  createStation('Chorleywood', ['Metropolitan']),
  createStation('Clapham Common', ['Northern']),
  createStation('Clapham North', ['Northern']),
  createStation('Clapham South', ['Northern']),
  createStation('Cockfosters', ['Piccadilly']),
  createStation('Colindale', ['Northern']),
  createStation('Colliers Wood', ['Northern']),
  createStation('Covent Garden', ['Piccadilly']),
  createStation('Croxley', ['Metropolitan']),
  createStation('Dagenham East', ['District']),
  createStation('Dagenham Heathway', ['District']),
  createStation('Debden', ['Central']),
  createStation('Dollis Hill', ['Jubilee']),
  createStation('Ealing Broadway', ['District', 'Central']),
  createStation('Ealing Common', ['District', 'Piccadilly']),
  createStation('Earls Court', ['District', 'Piccadilly']),
  createStation('East Acton', ['Central']),
  createStation('East Finchley', ['Northern']),
  createStation('East Ham', ['District', 'Hammersmith&City']),
  createStation('East Putney', ['District']),
  createStation('Eastcote', ['Metropolitan', 'Piccadilly']),
  createStation('Edgware', ['Northern']),
  createStation('Edgware Road', [
    'Bakerloo',
    'Hammersmith&City',
    'District',
    'CircleLine'
  ]),
  createStation('Elephant & Castle', ['Northern', 'Bakerloo']),
  createStation('Elm Park', ['District']),
  createStation('Embankment', ['District', 'Bakerloo', 'Northern', 'Circle']),
  createStation('Epping', ['Central']),
  createStation('Euston', ['Northern', 'Victoria']),
  createStation('Euston Square', [
    'Metropolitan',
    'Circle',
    'Hammersmith&City'
  ]),
  createStation('Farringdon', ['Metropolitan', 'Circle', 'Hammersmith&City']),
  createStation('Finchley Central', ['Northern']),
  createStation('Finchley Road', ['Metropolitan', 'Jubilee']),
  createStation('Finsbury Park', ['Piccadilly', 'Victoria']),
  createStation('Fulham Broadway', ['District']),
  createStation('Gants Hill', ['Central']),
  createStation('Gloucester Road', ['District', 'Piccadilly', 'CircleLine']),
  createStation('Golders Green', ['Northern']),
  createStation('Goldhawk Road', ['Hammersmith&City', 'Circle']),
  createStation('Goodge Street', ['Northern']),
  createStation('Grange Hill', ['Central']),
  createStation('Great Portland Street', [
    'Metropolitan',
    'Circle',
    'Hammersmith&City'
  ]),
  createStation('Greenford', ['Central']),
  createStation('Green Park', ['Piccadilly', 'Victoria', 'Jubilee']),
  createStation('Gunnersbury', ['District']),
  createStation('Hainault', ['Central']),
  createStation('Hammersmith', [
    'District',
    'Piccadilly',
    'Hammersmith&City',
    'Circle'
  ]),
  createStation('Hampstead', ['Northern']),
  createStation('Hanger Lane', ['Central']),
  createStation('Harlesden', ['Bakerloo']),
  createStation('Harrow & Wealdstone', ['Bakerloo']),
  createStation('Harrow-on-the-Hill', ['Metropolitan']),
  createStation('Hatton Cross', ['Piccadilly']),
  createStation('Heathrow Terminals 1, 2, 3', ['Piccadilly']),
  createStation('Heathrow Terminal 4', ['Piccadilly']),
  createStation('Heathrow Terminal 5', ['Piccadilly']),
  createStation('Hendon Central', ['Northern']),
  createStation('High Barnet', ['Northern']),
  createStation('Highbury & Islington', ['Victoria']),
  createStation('Highgate', ['Northern']),
  createStation('High Street Kensington', ['District', 'Circle']),
  createStation('Hillingdon', ['Metropolitan', 'Piccadilly']),
  createStation('Holborn', ['Central', 'Piccadilly']),
  createStation('Holland Park', ['Central']),
  createStation('Holloway Road', ['Piccadilly']),
  createStation('Hornchurch', ['District']),
  createStation('Hounslow Central', ['Piccadilly']),
  createStation('Hounslow East', ['Piccadilly']),
  createStation('Hounslow West', ['Piccadilly']),
  createStation('Hyde Park Corner', ['Piccadilly']),
  createStation('Ickenham', ['Metropolitan', 'Piccadilly']),
  createStation('Kennington', ['Northern']),
  createStation('Kensal Green', ['Bakerloo']),
  createStation('Kensington (Olympia)', ['District']),
  createStation('Kentish Town', ['Northern']),
  createStation('Kenton', ['Bakerloo']),
  createStation('Kew Gardens', ['District']),
  createStation('Kilburn', ['Jubilee']),
  createStation('Kilburn Park', ['Bakerloo']),
  createStation('Kingsbury', ['Jubilee']),
  createStation('Kings Cross St. Pancras', [
    'Metropolitan',
    'Northern',
    'Piccadilly',
    'Circle',
  ...
  createStation('Knightsbridge', ['Piccadilly']),
  createStation('Ladbroke Grove', ['Hammersmith&City', 'Circle']),
  createStation('Lambeth North', ['Bakerloo']),
  createStation('Lancaster Gate', ['Central']),
  createStation('Latimer Road', ['Hammersmith&City', 'Circle']),
  createStation('Leicester Square', ['Piccadilly', 'Northern']),
  createStation('Leyton', ['Central']),
  createStation('Leytonstone', ['Central']),
  createStation('Liverpool Street', [
    'Metropolitan',
    'Central',
    'Circle',
    'Hammersmith&City'
  ...
  createStation('Manor House', ['Piccadilly']),
  createStation('Mansion House', ['District', 'Circle']),
  createStation('Marble Arch', ['Central']),
  createStation('Marylebone', ['Bakerloo']),
  createStation('Monument', ['District', 'Circle']),
  createStation('Moorgate', [
    'Metropolitan',
    'Central',
    'Circle',
    'Hammersmith&City'
  ]),
  createStation('Moor Park', ['Metropolitan']),
  createStation('Morden', ['Northern']),
  createStation('Newbury Park', ['Central']),
  createStation('North Acton', ['Central']),
  createStation('North Greenwich', ['Jubilee']),
  createStation('Northwood', ['Metropolitan']),
  createStation('Northwood Hills', ['Metropolitan']),
  createStation('Notting Hill Gate', ['District', 'Central', 'Circle']),
  createStation('Old Street', ['Northern']),
  createStation('Oval', ['Northern']),
  createStation('Oxford Circus', ['Central', 'Bakerloo', 'Victoria']),
  createStation('Paddington', [
    'Hammersmith&City',
    'District',
    'Circle',
    'Bakerloo'
  ]),
  createStation('Parsons Green', ['District']),
  createStation('Piccadilly Circus', ['Bakerloo', 'Piccadilly']),
  createStation('Pimlico', ['Victoria']),
  createStation('Regents Park', ['Bakerloo']),
  createStation('Richmond', ['District']),
  createStation('St. Jamess Park', ['District', 'Circle']),
  createStation('St. Pauls', ['Central']),
  createStation('Shepherds Bush', ['Central']),
  createStation('Shepherds Bush Market', ['Hammersmith&City', 'Circle']),
  createStation('Sloane Square', ['District', 'Circle']),
  createStation('South Kensington', ['District', 'Piccadilly', 'Circle']),
  createStation('South Wimbledon', ['Northern']),
  createStation('Southfields', ['District']),
  createStation('Southwark', ['Jubilee']),
  createStation('Stockwell', ['Northern', 'Victoria']),
  createStation('Stratford', ['Central', 'Jubilee']),
  createStation('Temple', ['District', 'Circle']),
  createStation('Tooting Bec', ['Northern']),
  createStation('Tooting Broadway', ['Northern']),
  createStation('Tottenham Court Road', ['Central', 'Northern']),
  createStation('Tottenham Hale', ['Victoria']),
  createStation('Tower Hill', ['District', 'Circle']),
  createStation('Turnham Green', ['District', 'Piccadilly']),
  createStation('Upminster', ['District']),
  createStation('Upminster Bridge', ['District']),
  createStation('Upney', ['District']),
  createStation('Vauxhall', ['Victoria']),
  createStation('Victoria', ['District', 'Circle', 'Victoria']),
  ...
  createStation('West Kensington', ['District']),
  createStation('Westminster', ['District', 'Circle', 'Jubilee']),
  createStation('White City', ['Central']),
  createStation('Wimbledon', ['District']),
  createStation('Watford', ['Metropolitan'])
];
